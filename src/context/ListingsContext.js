...
export const ListingsProvider = ({ children }) => {
  const [listings, setListings] = useState([ 
    {"category": "", "description": "Iftar deal with the basic process and specific operation of the position", "imgUrl": "file:///data/user/0/com.firstapp/cache/rn_image_picker_lib_temp_791701f7-5e22-4acf-ac79-5894e04e1c39.jpg", "location": "31.483996, 74.3945499", "price": "252", "title": "Aftari"},
