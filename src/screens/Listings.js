...
export default function Listings({navigation}) {
    ...
    // const listings =  [{"category": "", "description": " injected humour, or non-characteristic words ", "imgUrl": "file:///data/user/0/com.firstapp/cache/rn_image_picker_lib_temp_c1dcde83-6869-4e1d-81a9-b07fffa21a15.jpg", "location": "", "price": "858", "title": "Lorem Ipsum"}, 
    ...
    <Box style={styles.container}>
        ...
        <VStack style={{ marginBottom: 0 }}>
                {listings?.map((p, index) => (
                    <Box padding={0} style={styles.card}>
                        <ListingsCard
                            key={index}
                            title={p.title}
                            price={p.price}
